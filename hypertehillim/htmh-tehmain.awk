...
BEGIN {
	html_start()
		...
		print "<p style=\"text-align:center;font-family:Miriam;font-size:7pt\">" "Downloaded from: " "<a style=\"font-family:Miriam;font-size:7pt;text-decoration:underline;\" href=http://mechon-mamre.org/i/t/t26.htm>http://mechon-mamre.org/i/t/t26.htm</a> at " strftime("%H:%M:%S %Z %b %d %Y",systime())
		
	system("awk -f htmh-tehpage.awk src-htm/t26.htm")
