...
BEGIN {
	html_start()
		...
		print "<p style=\"text-align:center;font-family:Miriam;font-size:7pt\">" "Downloaded from: " "<a style=\"font-family:Miriam;font-size:7pt;text-decoration:underline;\" href=http://mechon-mamre.org/i/t/t30.htm>http://mechon-mamre.org/i/t/t30.htm</a> at " strftime("%H:%M:%S %Z %b %d %Y",systime())
		
	system("awk -f htmh-shirpage.awk src-htm/t30.htm")
