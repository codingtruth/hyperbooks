...
BEGIN {
	html_start()
		...
		print "<p style=\"text-align:center;font-family:Miriam;font-size:7pt\">" "Downloaded and converted to PDF from: " "<a style=\"font-family:Miriam;font-size:7pt;text-decoration:underline;\" href=http://www.kab.co.il/heb/content/view/full/27219>http://www.kab.co.il/heb/content/view/ full/27219</a> at " strftime("%H:%M:%S %Z %b %d %Y",systime())
		

	printf "<hr><br><p style=\"text-align:center\">" "הרב יהודה אשלג, בעל הסולם" "</p>"
	printf "<h2>" "פתיחה לחכמת הקבלה" "</h1>"
	
	system("awk -f htmh-bs-ptihapage-format.awk out-htm/heb_bs_ptiha_utf_extracted.htm")
	system("awk -f htmh-bs-ptihapage-format.awk out-htm/heb_bs_ptiha_utf_extracted.htm")
	html_end()
}
