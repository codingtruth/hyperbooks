...
BEGIN {
	html_start()
		...
		print "<p style=\"text-align:center;font-family:Miriam;font-size:7pt\">" "Downloaded and converted to PDF from: " "<a style=\"font-family:Miriam;font-size:7pt;text-decoration:underline;\" href=http://mechon-mamre.org>http://mechon-mamre.org</a><br>at " strftime("%H:%M:%S %Z %b %d %Y",systime())
		
}

{
	scmd = sprintf("awk -f htmh-naviimpage.awk src-htm/%s.htm", $2)
	system(scmd)
}
